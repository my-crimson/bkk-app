...
export default function ManagementBeritaCreate() {
            ...
            <div className="crud-form">
                ...
                <form onSubmit={submit}>
                    <div className="form-group">
                        ...
                        <input value={data.judul} onChange={e => setData('judul', e.target.value)} required />
                    </div>
                    <div className="form-group">
                        <label>
                            Tanggal <span style={{ color: 'red' }}>*</span>
                        </label>
                        <input type="date" value={data.tanggal} onChange={e => setData('tanggal', e.target.value)} required />
                    </div>
                    <div className="form-group">
                        <label>
                            Jumlah Peserta
                        </label>
                        <input value={data.jml_peserta} onChange={e => setData('jml_peserta', e.target.value)} />
                    </div>
                    <div className="form-group">
                        <label>
                            Lokasi <span style={{ color: 'red' }}>*</span>
                        </label>
                        <input value={data.lokasi} onChange={e => setData('lokasi', e.target.value)} required />
                    </div>
                    <div className="form-group">
                        <label>
                            Deskripsi <span style={{ color: 'red' }}>*</span>
                        </label>
                        <textarea value={data.deskripsi} onChange={e => setData('deskripsi', e.target.value)} required ></textarea>
                    </div>
                    <div className="form-group">
                        <label>
                            Gambar <span style={{ color: 'red' }}>*</span>
                        </label>
                        <input type="file" accept="image/*" onChange={e => setData('gambar', e.target.files?.[0] ?? null)} required />
                    </div>
