            ...
            <div className="crud-form">
                ...
                <form onSubmit={submit}>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <Link href="/management/jurusan" className="btn-submit" style={{ backgroundColor: '#64748b', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            Kembali
                        </Link>
                        <button
                            type="submit"
